...
otherwise the version whose keywords the JD matches best (Apps Script
`v3/appsscript/Resumes.gs`, written to the Sheet's Resume column — see D21), otherwise
the default.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| resume_strategy | selection_strategy | employer_override_then_jd_keywords_then_default | global | 80 | ranking_signal | 2026-09-15 | keyword profiles live in the Sheet's Resumes tab |
